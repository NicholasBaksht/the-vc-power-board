...
const firmStages = {
  "caffeinated-capital": ["Seed", "Series A", "Series B", "Series C", "Growth"],
  "forum-ventures": ["Pre-Seed", "Seed"],
  "hof-capital": ["Pre-Seed", "Seed", "Series A", "Series B", "Series C"],
  "fifty-years": ["Pre-Seed", "Seed"],
  "kapor-capital": ["Seed", "Series A"],
  "compound": ["Seed", "Series A"],
  "ulu-ventures": ["Seed"],
  "thayer-ventures": ["Seed", "Series A", "Series B"],
  "serena-ventures": ["Pre-Seed", "Seed", "Series A"],
  "global-founders-capital": ["Pre-Seed", "Seed", "Series A", "Series B", "Series C", "Growth"],
  "alumni-ventures": ["Pre-Seed", "Seed", "Series A", "Series B", "Series C", "Growth"],
  "plug-and-play-ventures": ["Pre-Seed", "Seed"],
  "construct-capital": ["Seed", "Series A"],
  "fj-labs": ["Pre-Seed", "Seed", "Series A", "Series B", "Growth"],
  "inspired-capital": ["Pre-Seed", "Seed", "Series A"],
  "hyperplane": ["Pre-Seed", "Seed"],
  "boldstart-ventures": ["Pre-Seed", "Seed"],
  "operator-collective": ["Seed", "Series A"],
  "correlation-ventures": ["Seed", "Series A", "Series B"],
